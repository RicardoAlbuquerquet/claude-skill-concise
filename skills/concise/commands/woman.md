...
Write a ready-to-send reply to someone close venting about exhaustion, money,
shame, humiliation, dependence, or feeling stuck. The goal is to witness what
they're living, not solve, reframe, compare, or diagnose it.
...
Identify:
1. What happened.
2. What they say they feel.
3. The deeper exhaustion underneath it.
4. The detail carrying the most shame or humiliation.
5. How they describe themselves.
6. The feeling they end on.

## Write

Return one message ready to send, split into 2–3 short blocks that feel like
...
- Block 3: only if this is the start of the vent, say you're there and they can
  keep talking. If they're already mid-vent, stop at block 2.
...
- Solutions they didn't request.
- Minimizing or comparing their situation.
- "I get it", "I know exactly how you feel", or similar claims.
- Labels they didn't use for themselves.
- Stronger or harsher wording than theirs.
- Therapy language such as "validate", "hold space", "process", or "unpack".
- Narrating your own behavior like "I read everything" or "I won't fix this".
- Promising money or material help.
- Mimicking their abbreviations or emoji.
- Em dashes, semicolons, or mid-sentence colons.
- More than one "it's not X, it's Y" construction.

Use contractions, uneven sentence lengths, fragments when natural, and ordinary
phone-message language. Forced reassurance is worse than admitting there isn't
a sentence that makes it better.
