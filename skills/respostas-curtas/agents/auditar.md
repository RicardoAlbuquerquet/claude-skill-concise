---
name: auditar
description: Audita um rascunho contra o checklist de respostas-curtas antes de ele sair da conversa — uma resposta longa, uma descrição de PR, um corpo de tarefa ou issue. Devolve cada violação com a linha citada, a regra quebrada e a correção em uma linha, mais o conteúdo obrigatório que falta. Só audita; a reescrita é /respostas-curtas:reescrever.
...
caminho. Você reporta o que uma reescrita teria que corrigir; a reescrita em
si é outro comando.
