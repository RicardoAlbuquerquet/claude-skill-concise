...
Estilo de resposta, ativo em toda a sessão:
...
- O que sai da conversa tem arquivo na skill e um comando que o lê antes —
  `/pr`, `:card`, `:commit`, `:release`, `:comentario`,
...
O resto das regras fica ao lado deste arquivo, na tabela abaixo; leia o que casa quando o turno pedir mais que o trivial.
...
| Escrevendo | Leia |
|---|---|
| Resposta que passa de uma linha — orçamentos, estrutura, desenhos, recomendações | `respostas-curtas/completo.md` |
| Descrição de pull request | `respostas-curtas/pr.md` |
| Tarefa ou issue | `respostas-curtas/tarefa.md` |
| Mensagem de commit | `respostas-curtas/commit.md` |
| Entrada de changelog ou nota de release | `respostas-curtas/changelog.md` |
| Comentário, resposta em thread ou recado para uma pessoa | `respostas-curtas/comentario.md` |
| Comentário, mensagem ou texto de tela dentro do código | `respostas-curtas/codigo.md` |
