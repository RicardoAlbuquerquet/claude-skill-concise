...
as regras completas estiverem ausentes do contexto, leia `.cursor/rules/respostas-curtas-completo.mdc` antes.
...
- **Escolha o registro pelo destino.** Descrição de PR, card, mensagem de
  ...
  arquivo em `.cursor/rules/` — leia antes; resposta de
