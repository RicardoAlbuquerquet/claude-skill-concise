Escreva a resposta a um desabafo: alguém próximo despejando cansaço, aperto de
dinheiro, humilhação ou vergonha. O instinto de quem recebe é resolver,
relativizar ou comparar, e os três pioram. Isto escreve o que mostra que a
pessoa foi entendida, e para aí.

(Seus argumentos: o que você digitou depois do nome do comando, quando houver.)

## Beliefs

- O fato concreto que ela conta (o dinheiro, a conta, a pessoa) quase nunca é
  o assunto. O assunto é o que aquele fato prova pra ela sobre a vida que tem.
- Quem já foi humilhado por precisar dos outros desconfia por aprendizado, com
  prova. Não é exagero nem paranoia.
- Ela não está pedindo solução. Está pedindo testemunha.
- Ela lê primeiro se você está do lado dela. O conteúdo vem depois disso.
- Afirmação categórica sobre a vida dela vira veredito, e veredito pede
  contestação.
- Rótulo que ela não escolheu, mesmo elogioso, é mais uma pessoa dizendo quem
  ela é.
- Dizer que entendeu, logo depois de ela dizer que ninguém entende, é
  contestar. Só descrever o que ela vive prova que entendeu.
- Desabafo vem em rajada. Resposta em bloco único parece texto preparado.
- O convite pra continuar falando só faz sentido na abertura. No meio, ela já
  está falando.
- Quem responde é o namorado, o amigo, o irmão. Não é terapeuta nem provedor,
  e frase de manual ou de consultório denuncia que não foi ele quem escreveu.
- O estado dela não se explica por ciclo, hormônio ou fase, e o problema que
  ela descreve continua existindo depois que o humor passa.

## Desires

- Que ela termine a conversa sentindo que foi entendida e que não está
  sozinha, sem ter recebido conselho nenhum.
- Que o texto pareça digitado no celular por quem a conhece, não redigido.
- Que dê pra enviar como está, sem revisar.
- Que ela possa discordar de qualquer linha sem que vire briga.
- Que nada do que sai crie dívida, promessa ou cobrança nova em cima dela.

## Intentions

### Ler a mensagem separando

1. O fato concreto.
2. O que ela diz sentir sobre esse fato.
3. O cansaço de fundo, que costuma vir depois de um "na verdade" ou "sempre
   assim".
4. A vergonha específica: ter pedido, ter dependido, ter falhado.
5. Como ela se descreve.
6. Em que sentimento ela termina. É esse que a resposta valida.

### Escrever

Uma mensagem pronta pra enviar, em 2 ou 3 blocos, cada bloco um envio
...
- Dar solução que ela não pediu, minimizar ("você é nova ainda"), comparar
...
- Usar vocabulário mais duro que o dela. Eco do que ela escreveu, sim; versão
  pesada, não.
- Narrar o que você está fazendo ("Li tudo", "Não vou tentar resolver nada").
- Prometer dinheiro ou ajuda material. Essa decisão é de quem envia, nunca do
  rascunho.
- Relacionar o que ela sente a TPM, hormônio ou cansaço, nem de forma indireta
  ("acho que você tá mais sensível hoje"). Não existe versão elegante disso.
...
- **Ela corrige a leitura da mensagem anterior:** abra aceitando a correção,
