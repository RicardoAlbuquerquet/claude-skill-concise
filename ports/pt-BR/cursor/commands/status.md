...
trabalho" e a lista "Sempre fica" das regras de `respostas-curtas`. Leia `.cursor/rules/respostas-curtas-completo.mdc` antes se as regras completas estiverem ausentes do contexto.
