...
- Human-facing message: `/comment`
- Text in code/UI: `/trim`
- Diagram: `/draw`
- Status: `/status`
- Handoff: `/handoff`
...
- The rest of the ruleset sits beside this file, in the table below; read the one that matches whenever the task is more than trivial.
