...
off what it names by a `│` down to a `└─`; `/draw` carries the rest.
...
|---|---|---|
| A pull request description | `concise/pull-request.md` | `/pr` |
| A task or an issue | `concise/task.md` | `/card` |
| A commit message | `concise/commit.md` | `/commit` |
| A changelog entry or release notes | `concise/changelog.md` | `/release` |
| A comment, a reply or a message to a person | `concise/comment.md` | `/comment` |
| Comments, messages or screen text in code | `concise/code.md` | `/trim` |
