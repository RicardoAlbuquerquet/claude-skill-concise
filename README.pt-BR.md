...
`Bash` e `PowerShell`. Limite conhecido: mensagem passada como arquivo
(`git commit -F notas.txt`) fica fora do alcance da string do comando. Sair
dela significa desligar os hooks do plugin.
